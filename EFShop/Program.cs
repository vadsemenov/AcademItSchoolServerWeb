...
namespace EFShop
{
    public class Program
    {
        ...
        {
            var shopContext = new ShopDbContext();

            FillDatabase(shopContext);

            var mostFrequentlyPurchasedProducts = ShopService.GetMostFrequentlyPurchasedProducts(shopContext);
        ...
        public static void FillDatabase(ShopDbContext shopContext)
        {
            ...
            shopContext.Orders.AddRange(order1, order2, order3, order4, order5);
            ...
            shopContext.OrderItems.AddRange(orderItem11, orderItem12, orderItem21,
